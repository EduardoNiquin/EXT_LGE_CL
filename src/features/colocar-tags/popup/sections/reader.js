...
const log = logger('colocar-tags/reader');
...
async function loadPageData() {
  ...
  try {
    ...
    stateEl.innerHTML = `<p>Error: ${escapeHtml(err.message)}</p><p class="ct-state-hint">Asegúrate de tener la pestaña de GP1 abierta y refresca la página.</p>`;
  }
}
