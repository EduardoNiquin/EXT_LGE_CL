// Router del feature "Starkoms". Por ahora una sola sección
// ("Verificar órdenes y stock"); estructura lista para sumar más.

import * as verify from './sections/verify.js';

const SECTIONS = [
  { id: 'verify', label: 'Verificar órdenes y stock', render: verify.render },
];

const DEFAULT_SECTION = 'verify';
...
export function render(container) {
  ...
  container.innerHTML = `
    ...
    <div id="sk-section" class="ct-section-host"></div>
  `;

  const host = container.querySelector('#sk-section');
